...
template<class RowMax, class RowSum, class SoftType, class TiledMma0, class GmemLayoutMI,
         class TileShapeO>
__device__ static void   //__launch_bounds__(128, 2)
fmhaForwardWriteOutSoftMax(const RowMax& rowMax, const RowSum& rowSum, SoftType* mi_ptr, SoftType* sPrimePtr, GmemLayoutMI gmemLayoutMi, const TiledMma0& tiledMma0, TileShapeO tileShapeO)
{
    ...
    Tensor miGlobalOut =
        local_tile(miGlobal, make_shape(get<0>(tileShapeO), 1, 1), make_coord(blockIdxX, blockIdxH, blockIdxB));
    Tensor sPrimeGlobal = make_tensor(make_gmem_ptr(sPrimePtr), gmemLayoutMi);
    Tensor sPrimeGlobalOut =
        local_tile(sPrimeGlobal, make_shape(get<0>(tileShapeO), 1, 1), make_coord(blockIdxX, blockIdxH, blockIdxB));
    if (threadIdx.x % 4 == 0)
    {
...
template<class TensorO, class RowMax, class RowSum, class SoftType, class OutputType, class TiledMma1, class TileShapeO,
         class GmemLayoutO>
__device__ static void   //__launch_bounds__(128, 2)
fmhaForwardWriteOut(TensorO& tOrO, const RowMax& rowMax, const RowSum& rowSum, OutputType* O, TileShapeO tileShapeO, GmemLayoutO gmemLayoutO, const TiledMma1& tiledMma1, const SoftType&)
{
...
template<class TensorO, class RowMax, class RowSum, class SoftType, class OutputType, class TiledMma1, class TileShapeO, class GmemLayoutO, class TensorSO,
         class ThreadLayoutO>
__device__ static void   //__launch_bounds__(128, 2)
fmhaForwardWriteOutCoalesced(TensorO& tOrO, const RowMax& rowMax, const RowSum& rowSum, OutputType* O, TileShapeO tileShapeO, GmemLayoutO gmemLayoutO, const TiledMma1& tiledMma1, const TensorSO& sO, ThreadLayoutO tO, const SoftType&)
{
...
template<class TensorO, class RowMax, class RowSum, class SoftType, class OutputType, class TiledMma1, class TileShapeO, class GmemLayoutO, class TensorSO,
         class TiledCopyO>
__device__ static void   //__launch_bounds__(128, 2)
fmhaForwardWriteOutTMA(TensorO& tOrO, const RowMax& rowMax, const RowSum& rowSum, OutputType* O, TileShapeO tileShapeO, GmemLayoutO gmemLayoutO, const TiledMma1& tiledMma1, const TensorSO& sO, TiledCopyO const& tmaStoreO, bool leaderWarp, const SoftType&)
{
