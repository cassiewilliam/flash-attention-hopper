...
template<class ElementA, class ElementB, class ElementC, class TileShape_MNK, GMMA::Major MajorA = GMMA::Major::K, GMMA::Major MajorB = GMMA::Major::K,
...
CUTE_HOST_DEVICE constexpr auto ss_op_selector_custom()
{
    ...
    else
    {
        ...
        return cute::GMMA::ss_op_selector<ElementA, ElementB, ElementC, TileShape_MNK, MajorA, MajorB, Args...>();
    }
}
...
CUTE_HOST_DEVICE constexpr auto rs_op_selector_custom()
{
    ...
    else
    {
        ...
        return cute::GMMA::rs_op_selector<ElementA, ElementB, ElementC, TileShape_MNK, MajorA, MajorB, Args...>();
    }
}
