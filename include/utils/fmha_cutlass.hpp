...
public:
    ...
    TestAttention(int _head_number, int _batch_size, int _head_size, int _seq_length, int _alignment = 1, bool use_mask = false, bool causal = false)
    {
...
public:
    ...
    void compute(const ElementQ* Q, const ElementK* K, const ElementV* V, ElementS* S, ElementO* O, ElementNorm* norm, ElementSum* sum, bool usePow2 = false, bool usePreScaling = true)
    {
        ...
        for (int64_t b = 0; b < batch_size; ++b)
        {
            ...
            for (int64_t h = 0; h < head_number; ++h)
            {
                ...
                cutlass::TensorView<ElementS, LayoutP>       view_S(offsetS, layout_P, extent_P);
                cutlass::TensorView<ElementO, LayoutO>       view_O(offsetO, layout_O, extent_O);
                ...
                cutlass::reference::device::GemmComplex<
                    ...
                    ElementAccumulator,
                    ElementCompute>(
                    problem0, ElementAccumulator(alphaMma0), view_Q, cutlass::ComplexTransform::kNone, view_K, cutlass::ComplexTransform::kNone, ElementAccumulator(beta), view_P, view_P, ElementAccumulator(0));
                ...
                cutlass::device_memory::copy_to_device(offsetS, matrix_Ref_S.data(), matrix_Ref_S.size());
                ...
                cutlass::reference::device::GemmComplex<
                    ...
                    ElementAccumulator,
                    ElementCompute>(
                    problem1, ElementAccumulator(alpha1), view_P, cutlass::ComplexTransform::kNone, view_V, cutlass::ComplexTransform::kNone, ElementAccumulator(beta), view_O, view_O, ElementAccumulator(0));
            }
        }
    }
};
